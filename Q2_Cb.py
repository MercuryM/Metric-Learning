...
"""
Spyder Editor
This is softmax probability of inverse distance representation
...
#            feature_vec[m,n] = feature_vec[m,n]/1.0
...
rank_accuracies, mAP = evaluate_metric(softmax_p, test_l, softmax_p, test_l,
                                       metric ='euclidian',
                                       parameters = None)
...
plt.title('KNN Results of Softmax Probabilities of Inverse Distance versus Cluster Numbers')  
#plt.show()
plt.savefig('img/KNN Results of Softmax Probabilities of Inverse Distance versus Cluster Numbers.png',
